<div class="card-body px-0 pb-2">
    <div class="table-responsive">
        <table class="table align-items-center mb-0" id="welfarePayment">
            <thead>
                <tr>
            ...
            <tbody>
                @if($payments->where('payment_status', 'welfare_registration'))
                    @foreach ($payments->where('payment_status', 'welfare_registration') as $payment)
                        <tr>
