            ...
            <div class="card-header pb-0">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-7 d-flex justify-content-end">
                        <a href="{{ route('galleries.create') }}"><button class="btn btn-success">Create</button></a>
                    </div>
                </div>
            </div>
            <br>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle d-flex justify-content-center">
                                            <div class="d-flex px-2 py-1 text-center">
                                                    <img src="{{ asset('storage/gallaries/' . $photo->image) }}"
                                                        class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                            </div>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $galary->created_at}}</span>
                                        </td>
                                        <td class="align-middle text-center d-flex justify-content-around">
                                            {{-- <a href="#">
                                                <span class="btn btn-sm btn-warning btn-sm">View</span>
                                            </a> --}}
                                            <form class="ml-2" action="{{ route('galleries.destroy',  $galary->id) }}" method="post">
                                                @csrf
                                                @method('delete')
