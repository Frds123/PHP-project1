                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-12 mt-6 mt-sm-0">
                            <div class="input-group input-group-dynamic">
                                <label class="form-label">Committee Name</label><br>
                                <x-admin.widgets.text-input id="committee_name" class="form-control" type="text" name="committee_name" required autofocus />
                            </div>
                        </div>
                    </div>
